...
step = tf.keras.layers.Conv2D(         filters=5,      kernel_size=3,      strides=(2, 2),     padding="same", )(imt)
tf.print(tf.shape(step))
step = tf.keras.layers.Conv2D(         filters=10,     kernel_size=3,      strides=(2, 2),     padding="same", )(step)
tf.print(tf.shape(step))
step = tf.keras.layers.Conv2D(         filters=10,     kernel_size=3,      strides=(2, 2),     padding="same", )(step)
tf.print(tf.shape(step))
step = tf.keras.layers.Conv2D(         filters=20,     kernel_size=3,      strides=(2, 2),     padding="same", )(step)
tf.print(tf.shape(step))
step = tf.keras.layers.Conv2D(         filters=40,     kernel_size=3,      strides=(2, 2),     padding="same", )(step)
tf.print(tf.shape(step))
step = tf.keras.layers.Conv2D(         filters=40,     kernel_size=3,      strides=(2, 2),     padding="same", )(step)
tf.print(tf.shape(step))
print("bottom")
tf.print(tf.shape(step))
step = tf.keras.layers.Conv2DTranspose( filters=40,     kernel_size=3,      strides=2,      padding="same",     output_padding=(1, 1) )(step)
tf.print(tf.shape(step))
step = tf.keras.layers.Conv2DTranspose( filters=20,     kernel_size=3,      strides=2,      padding="same",     output_padding=(1, 1) )(step)
tf.print(tf.shape(step))
step = tf.keras.layers.Conv2DTranspose( filters=10,     kernel_size=3,      strides=2,      padding="same",     output_padding=(0, 0) )(step)
tf.print(tf.shape(step))
step = tf.keras.layers.Conv2DTranspose( filters=10,     kernel_size=3,      strides=2,      padding="same",     output_padding=(0, 0) )(step)
tf.print(tf.shape(step))
step = tf.keras.layers.Conv2DTranspose( filters=5,      kernel_size=3,      strides=2,      padding="same",     output_padding=(1, 1) )(step)
tf.print(tf.shape(step))
step = tf.keras.layers.Conv2DTranspose( filters=1,      kernel_size=3,      strides=2,      padding="same",     output_padding=(1, 1) )(step)
tf.print(tf.shape(step))
